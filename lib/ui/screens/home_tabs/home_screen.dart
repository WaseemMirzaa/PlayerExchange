                          ...
                          return InkWell(
                              onTap: () {
                                Get.to(RosterDetailScreen(
                                    rosterModel: homeScreenController.rosterController
                                        .rosterList[index]));
                              },
                              child: RoasterListItem());
                        },
                        itemCount: homeScreenController.rosterController
                            .rosterList.length > 3 ? 3 : homeScreenController.rosterController
                            .rosterList.length,
