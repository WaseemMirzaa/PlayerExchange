...
class APIRequests {
  ...
  static Future<FavoriteModel?> doApi_addToWatchList(
  ...
  static Future<List<FavoriteModel>> doApi_getWatchList(String userId ,{String playerId = ""}) async {
    String jsonStringFilter = '?filter={"where": {"userId": "$userId"},"include": [{"relation": "cpoAthletes"}]}';


    if(playerId.isNotEmpty) {
      jsonStringFilter =
      '?filter={"where": {"userId": "$userId", "cpoAthletesId": "$playerId"}}';
    }
