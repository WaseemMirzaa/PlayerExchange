...
class CreatePaymentIntentResponse {
	...
	CreatePaymentIntentResponse({this.data});

	CreatePaymentIntentResponse.fromJson(Map<String, dynamic> json) {
...
class Data {
	...
	Data({this.paymentIntent, this.clientSecret});

	Data.fromJson(Map<String, dynamic> json) {
		paymentIntent = json['paymentIntent'] != null ? new PaymentIntent.fromJson(json['paymentIntent']) : null;
	...
	Map<String, dynamic> toJson() {
      ...
      data['paymentIntent'] = this.paymentIntent!.toJson();
    }
...
class PaymentIntent {
	...
	PaymentIntent({this.id, this.object, this.amount, this.amountCapturable, this.amountDetails, this.amountReceived, this.application, this.applicationFeeAmount, this.automaticPaymentMethods, this.canceledAt, this.cancellationReason, this.captureMethod, this.charges, this.clientSecret, this.confirmationMethod, this.created, this.currency, this.customer, this.description, this.invoice, this.lastPaymentError, this.livemode, this.metadata, this.nextAction, this.onBehalfOf, this.paymentMethod, this.paymentMethodOptions, this.paymentMethodTypes, this.processing, this.receiptEmail, this.review, this.setupFutureUsage, this.shipping, this.source, this.statementDescriptor, this.statementDescriptorSuffix, this.status, this.transferData, this.transferGroup});
	...
	PaymentIntent.fromJson(Map<String, dynamic> json) {
		...
		charges = json['charges'] != null ? new Charges.fromJson(json['charges']) : null;
	...
	Map<String, dynamic> toJson() {
      ...
      data['amount_details'] = this.amountDetails!.toJson();
		...
		data['automatic_payment_methods'] = this.automaticPaymentMethods;
